...
<head>
    ...
    <title>SPK Penerimaan Mahasiswa Baru</title>
            ...
            <div class="container-fluid">
                ...
                <!--<img class="img" src="mandiri.png" alt="">-->
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" style="font-weight: bold; color: green;" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Program Studi <span class="caret"></span></a>
                          <ul class="dropdown-menu">
                            <?php $query = $connection->query("SELECT * FROM prodi"); while ($row = $query->fetch_assoc()): ?>
                              <li><a href="?page=perhitungan&prodi=<?=$row["kd_prodi"]?>"><?=$row["nama_prodi"]?></a></li>
                            <?php endwhile; ?>
                          </ul>
                        </li>
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="?page=prodi">Daftar Program Studi</a></li>
                            <li class="divider"></li>
                            <li><a href="?page=camaba">Daftar Calon Mahasiswa Baru</a></li>
